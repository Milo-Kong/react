...
import IntoEaster_ABI from '@/ABI/IntoEaster.json'
...
export const IntoEaster_CONTRACT: ContractInterface = {
  abi: IntoEaster_ABI,
  addresses: {
    [ChainID.MATCH]: "0x244d2932252E762189cF780C1141AC5E9AA1c1C3",
    [ChainID.MATCH_TESTNET]: "0x39959499ab04306ab6927f049148fCDbE35e1D31",
  }
};