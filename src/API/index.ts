...
// instance.defaults.baseURL = 'https://test-5897.intodevs.com'
instance.defaults.baseURL = 'https://wallet-api-v2.intowallet.io/'
...
export async function getRequestCustom(url:string,config?:any) {
  return new Promise((resolut,reject)=>{
    instance.get(url,config).then((result:any)=>{
      if (result.status == 200){
